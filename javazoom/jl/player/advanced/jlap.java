...
public class jlap {
   ...
   public static AdvancedPlayer playMp3(File mp3, PlaybackListener listener) throws JavaLayerException, IOException {
      return playMp3(mp3, 0, Integer.MAX_VALUE, listener);
   }

   public static AdvancedPlayer playMp3(File mp3, int start, int end, PlaybackListener listener) throws JavaLayerException, IOException {
