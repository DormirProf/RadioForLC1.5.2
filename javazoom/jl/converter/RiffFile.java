         ...
         case 2:
            try {
               ...
               try {
                  ...
                  this.fmode = 2;
                  this.riff_header.ckID = ioe[0] << 24 & -16777216 | ioe[1] << 16 & 16711680 | ioe[2] << 8 & '\uff00' | ioe[3] & 255;
                  this.riff_header.ckSize = ioe[4] << 24 & -16777216 | ioe[5] << 16 & 16711680 | ioe[6] << 8 & '\uff00' | ioe[7] & 255;
